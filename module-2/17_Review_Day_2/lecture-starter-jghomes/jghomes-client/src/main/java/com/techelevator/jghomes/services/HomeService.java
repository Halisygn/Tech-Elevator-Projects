...
public class HomeService {
    ...
    public Home[] retrieveListByZip(int zip) throws HomeServiceException {

        Home[] homes = null;
        try {
            homes = restTemplate.exchange(BASE_SERVICE_URL + "homes/filter?zip=" + zip,
                    HttpMethod.GET, makeAuthEntity(), Home[].class).getBody();
        }
        catch (RestClientResponseException ex) {
            throw new HomeServiceException(ex.getRawStatusCode() + " : " + ex.getResponseBodyAsString());
        }
    ...
    public void updateHome(Home home) throws HomeServiceException {
        ...
        try {
            restTemplate.exchange(BASE_SERVICE_URL + "homes/" + home.getMlsNumber(), HttpMethod.PUT, makeHomeEntity(home), String.class);
        }
        catch (RestClientResponseException ex) {
            throw new HomeServiceException(ex.getRawStatusCode() + " : " + ex.getResponseBodyAsString());
        }
