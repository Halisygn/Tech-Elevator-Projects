...
export default {
  ...
  methods: {
    ...
    handleErrorResponse(error) {
      if (error.response) {
        this.errorMsg =
          "Error adding a new home. Error: " + error.response.status;
      } else if (error.request) {
        this.errorMsg =
          "Error adding a new home. Server unavailable, Error: " + error.status;
      } else {
        this.errorMsg =
          "Java Green has left you high and dry. Pick better developers next time!";
      }
    },
  },
};
